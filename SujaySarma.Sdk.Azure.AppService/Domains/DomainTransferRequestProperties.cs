...
namespace SujaySarma.Sdk.Azure.AppService.Domains
{
    ...
    /// </summary>
    public class DomainTransferRequestProperties
    {
        /// <summary>
        ...
        /// <summary>
        /// Authorization code received from current registrar to authorize this transfer
        /// </summary>
        ...
        /// Default constructor
        /// </summary>
        public DomainTransferRequestProperties() { }
    }
